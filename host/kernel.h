//
// kernel.h — the Circle kernel that hosts fheroes2.
//
// Device ownership: this kernel brings up interrupts, the timer, a serial
// console carrying stdio, the SD card (FatFs, holding the Heroes II data
// files, the maps and the save games) and the cooperative scheduler. Video,
// USB input and audio belong to circle-libsdl2 and are created inside
...
//   core 1   the APPLICATION core. fheroes2, alone: the game loop and
//            nothing else. Every platform call it makes is marshalled back
//            to core 0 by the shim.
