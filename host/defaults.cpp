...
//     fheroes2-defaults.ld pins to image offset 0x800. It ships with the
...
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".fh2.defaults"), used, aligned (8)))
#else
